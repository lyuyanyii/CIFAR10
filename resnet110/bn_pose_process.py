...
def _get_dataset_mean_var(data, func, i):
	...
	p = InputPipe("lyy.CIFAR10.resnet20.train_mypipe", buffer_size = 1000)
	with control(io = [p]):
...
bn_post_process("data/resnet110.data", "resnet110.data_bned", load_data("/home/liuyanyi02/CIFAR/cifar-10-batches-py/test_batch"))
